...
$circle = array('number'=>3, 'date'=>'20 октября 2013', 'title'=>'Весы');
...
$tasks[] = 'Имеются чашечные весы без гирь и 3 одинаковые по внешнему виду монеты. Одна из монет фальшивая, причём неизвестно, легче она настоящих монет или тяжелее (настоящие монеты одного веса). Сколько надо взвешиваний, чтобы определить фальшивую монету? А если монет было 4? 16? 9? 27?';
...
$tasks_add[] = 'У продавца имеются чашечные весы с неравными плечами и гири. Сначала он взвешивает товар на одной чашке, затем – на другой, и берет средний вес. Не обманывает ли он?';
